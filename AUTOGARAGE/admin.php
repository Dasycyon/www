	 ...
	 <div class="container">
		 ...
		 <nav class="navbar navbar-default">
				  ...
				  <ul class="nav navbar-nav">
					...
					<li class="active"><a href="admin.php">Администрирование</a></li>
					</ul>
			 </div>
	      </nav>					
	 </div>
...
{  
    ...
    $checklogin = mysqli_query($conn, "SELECT * FROM admin WHERE Username = '".$username."' AND Password = '".$password."'");  
...
{?>
<br><h1 align="center">Администрирование</h1>  <br>
<p align="center"> Для входа в режим администрирования введите следующую информацию: </h1> <br> <br>
<form method="post" align="center" action="admin.php" name="loginform" id="loginform"> 
<p><label for="username">Логин:*</label><br><input type="text" name="username" id="username" placeholder="Логин"></p> 
<p><label for="username">Пароль:*</label><br><input type="password" name="password" id="password" placeholder="Пароль"></p><br> 
<p class="submit"><input type="submit" name="commit" value="Войти"></p> 
  <br> <br>  <p> * - поля,обязательные для заполнения</p>  <br> <br>   <br> <br><br>
  </form> 
<?php
}?>
</div>
