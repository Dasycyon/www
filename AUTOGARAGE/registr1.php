	 ...
	 <div class="container">
		 ...
		 <nav class="navbar navbar-default">
				  ...
				  <ul class="nav navbar-nav">
					...
					<li class="active"><a href="registr1.php">Регистрация</a></li>
...
<br><h1 align="center"><b>Регистрация</b></h1>  <br>
   ...
   <p align="center">Для регистрации на сайте необходимо ввести следующую информацию: </p>  <br>
 
    <form method="post" action="registr1.php" name="registerform" id="registerform" align="center">  
    <fieldset>  
