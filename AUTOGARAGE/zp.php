...
<br><h1 align="center"> Таблица "Зарплата"</h1><br>
...
$result=mysqli_query($conn, "SELECT zarplata.id_zarp, sotrudniki.FIO, zarplata.oklad, zarplata.premia, zarplata.zarplata
                     from zarplata INNER JOIN sotrudniki
                     on zarplata.id_sotrud=sotrudniki.id_sotrud")
or die(mysqli_error());
...
<br><center><button href="javascript://" onclick="print();" class="but2">Печать</button></center><br>
  <div class="clearfix"></div>
		...
		<div class="footer2">	
			...
			<p>Все права защищены &<?php echo date("Y") ?>.  Копирование материалов допускается только с указанием активной ссылки на сайт <a href="index.php">AUTO GARAGE</a></p>
	 </div>
</div>
